...
import in.winvestco.portfolio_service.messaging.serialization.ProtobufDeserializer;
...
public class MarketQuoteKafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:portfolio-service-market-quote-consumer}")
    private String groupId;

    @Value("${spring.kafka.consumer.auto-offset-reset:earliest}")
    private String autoOffsetReset;

    @Value("${spring.kafka.topics.market-quote.dlt-name:market.quote.v1.dlt.portfolio-service}")
