...
public class TradeController {
    ...
    @Operation(
            ...
            description = "Retrieves a trade by its unique trade ID",
            responses = {
    ...
    @Operation(
            ...
            description = "Retrieves the trade associated with a specific order",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Trade found"),
    ...
    @Operation(
            ...
            description = "Retrieves all trades for the authenticated user with pagination",
            responses = {
    ...
    @Operation(
            ...
            description = "Retrieves all active (non-terminal) trades for the authenticated user",
            responses = {
    ...
    @Operation(
            ...
            description = "Cancels an active trade",
            responses = {
    ...
    @Operation(
            summary = "Simulate trade execution (Testing)",
            description = "Simulates a full trade execution for testing purposes",
            responses = {
