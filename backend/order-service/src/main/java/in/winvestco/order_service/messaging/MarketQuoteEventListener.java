...
import in.winvestco.order_service.service.MarketQuoteProjectionService;
...
public class MarketQuoteEventListener {
    ...
    @KafkaListener(
            ...
            groupId = "${spring.kafka.consumer.group-id:order-service-market-quote-consumer}",
    ...
    public void onQuoteEvent(
        ...
        try {
            ...
            meterRegistry.counter("market_quote_consumed_total", "service", "order-service", "result", "success")
                    .increment();
            ...
            meterRegistry.counter("market_quote_consumed_total", "service", "order-service", "result", "failure")
                    .increment();
    ...
    private void recordConsumerLag(Consumer<?, ?> consumer, String topic, int partition) {
        try {
            ...
            if (endOffset != null) {
                ...
                meterRegistry.summary("market_quote_consumer_lag_records", "service", "order-service")
                        .record(lag);
            }
        } catch (Exception e) {
