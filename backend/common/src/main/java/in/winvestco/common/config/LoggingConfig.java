...
/**
 * Enhanced centralized logging configuration for servlet-based services.
 * Provides consistent logging setup, request tracing, and structured logging
 * across the application.
 * Only active for servlet-based (WebMVC) applications.
 */
@Slf4j
@Configuration("servletLoggingConfig")
...
public class LoggingConfig implements WebMvcConfigurer {
    ...
    /**
     * Request logging interceptor for automatic request/response logging and
     * tracing
     */
