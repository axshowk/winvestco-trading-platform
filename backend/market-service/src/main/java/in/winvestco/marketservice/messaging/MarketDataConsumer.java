...
public class MarketDataConsumer {
         ...
         */
        @KafkaListener(topics = TOPIC_NAME, groupId = GROUP_ID, containerFactory = "protobufKafkaListenerContainerFactory")
        public void consumeMarketData(
                ...
                try {
                        ...
                        // Note: In a production system, you might want to consider negative
                        // acknowledgment (nack)
                        // or dead-letter queuing for persistent failures, but for now we log and
                        // proceed.
                }
        }
