...
import { TrendingUp, TrendingDown, X, Search, ArrowUpDown, BarChart3 } from 'lucide-react';
                        ...
                        <div className="modal-content glass" onClick={e => e.stopPropagation()}>
                            ...
                            <div className="modal-header">
                                ...
                                <div className="modal-price-info">
                                    ...
                                    <span className={`price-change ${selectedStock.change >= 0 ? 'positive' : 'negative'}`}>
                                        ...
                                        ({(selectedStock.changeValue || 0).toFixed(2)})
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="modal-grid">
                                ...
                                <div className="detail-item">
                                    ...
                                    <span className="value">{formatNumber((selectedStock.totalTradedValue || 0) / 100000)}</span>
                                </div>
                            </div>
